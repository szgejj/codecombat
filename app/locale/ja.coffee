...
#    classroom_not_found: "No classes exist with this Class Code. Check your spelling or ask your teacher for help."
    checking: "確認しています..."
    account_exists: "このe-mailはとられています"
    sign_in: "Sign inする"
    email_good: "このe-mailは使えます!"
    name_taken: "このユーザーネームはとられています!{{suggestedName}}　を使って見ませんか？"
...
#    activity_button_1: "View Lesson"
    ...
    about_copy: "CodeCombat はゲーム見たいなCSを教えてくれるプログラムです。CodeCombatはPythonとJavaScriptを教えてくれます。CodeCombatはちゃんとプログラミングコンセプトを教えながらみんながたのしめるようにできています。1.2千万人以上CodeCombatを使っています。" # {change}
    point1: "✓ ベースが分かりやすい"
    point2: "✓ 生徒に合うように調整する"
